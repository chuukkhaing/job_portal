    ...
    static principal( datos2 = {}){
        ...
        $(function(){
            ...
            ${datos.button
                    ...
                    <button type="button" class="MSalert-principal-button-blue MSalert-principal-button-extraPadding" onclick="MSalert.confirmationPrincipal(true)">Yes</button>
                    ...
                    : `<button type="button" class="MSalert-principal-button-blue" onclick="MSalert.closePrincipal()">OK</button>`}
    ...
    static icons(name,color='#000',width=24,height=24){
        ...
        switch(name){
            ...
            <path
                ...
                inkscape:connector-curvature="0"
                id="path2922-6-6-0"
                style="color:#000000;fill:#17A2B8;fill-opacity:1;fill-rule:nonzero;stroke:none;stroke-width:0.84323651;marker:none;visibility:visible;display:inline;overflow:visible;enable-background:accumulate" />
            </g>`;break;
        }

        return `<svg xmlns="http://www.w3.org/2000/svg" class="MSalert-principal-ventana-icon" width="${width}" height="${height}" viewBox="0 0 16 16">${content}</svg>`
    }
