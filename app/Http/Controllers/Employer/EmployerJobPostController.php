        ...
        if($jobApply->count() > 0){
            ...
            if($seeker->country == 'Myanmar') {
                $seeker = DB::table('seekers as a')
                            ...
                            ->select('a.*','b.name as state_name','c.name as township_name','a.image as image')
                            ->first();
            }
            ...
            $seeker_img = getS3File('seeker/profile/'.$jobApply->first()->seeker_id ,$seekerimg);
        }
        $item_id = Null;
