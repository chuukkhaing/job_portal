                    ...
                    <div class="m-0 mb-2 pb-0 seeker-job-list border rounded">
                        <div class="row m-0">
                            <div class="col-2">
                                ...
                                <img src="{{ asset('storage/employer_logo/'.$jobPost_detail->Employer->logo) }}" alt="Profile Image" class="seeker-profile rounded-circle" style="width: 60px" id="ProfilePreview">
                                @else 
                                <img src="{{ asset('img/profile.svg') }}" alt="Profile Image" class="seeker-profile rounded-circle" style="width: 60px" id="ProfilePreview">
                                @endif
                            </div>
                            <div class="col-6">
