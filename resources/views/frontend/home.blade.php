                    ...
                    <div class="row">
                        ...
                        <div class="col-9 p-0">
                            ...
                            <div class="fz13">
                                ...
                                @if($trending_job->country == 'Myanmar' && $trending_job->township_id )<span><i class="fa fa-map-marker me-1" aria-hidden="true"></i> {{ $trending_job->Township->name }}</span> @elseif($trending_job->country == 'Other') <span><i class="fa fa-map-marker me-1" aria-hidden="true"></i>{{ $trending_job->country }} </span>@endif
                            </div>
                        </div>
                    </div>
                </div>
