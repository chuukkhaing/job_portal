        ...
        <div class="row m-0 p-0">
            <div class="col-12 col-sm-3 col-md-4 col-lg">
                <div class="form-group">
                    <select name="industry" id="industry" class="form-input find-jobs-input w-100" @if(isset($_GET['industry'])  && $_GET['industry'] != "") style="border: 2px solid #FB5404;" @endif>
            ...
            <div class="col-12 col-sm-3 col-md-4 col-lg">
                <div class="form-group">
                    <select name="job_type" id="job_type" class="form-input find-jobs-input w-100" @if(isset($_GET['job_type']) && $_GET['job_type'] != "") style="border: 2px solid #FB5404;" @endif>
            ...
            <div class="col-12 col-sm-3 col-md-4 col-lg">
                <div class="form-group">
                    <select name="career_level" id="career_level" class="form-input find-jobs-input w-100" @if(isset($_GET['career_level']) && $_GET['career_level'] != "") style="border: 2px solid #FB5404;" @endif>
            ...
            <div class="col-12 col-sm-3 col-md-4 col-lg">
                <div class="form-group">
                    <select name="qualification" id="qualification" class="form-input find-jobs-input w-100" @if(isset($_GET['qualification']) && $_GET['qualification'] != "")style="border: 2px solid #FB5404;" @endif>
            ...
            <div class="col-12 col-sm-3 col-md-4 col-lg">
                <div class="form-group">
                    <select name="job_sorting" id="job_sorting" class="form-input find-jobs-input w-100" @if(isset($_GET['job_sorting']) && $_GET['job_sorting'] != "") style="border: 2px solid #FB5404;" @endif>
