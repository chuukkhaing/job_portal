...
<div class="my-2 row">
    <div id="language-table" class="d-none">
        ...
        if(language_name != '' && language_level != '')
        {
            ...
            $.ajax({
                ...
                if(response.status == 'success') {
                    ...
                    $('.language_label').append('<div class="row skill-list language-resume-'+response.language.id+'"><div class="col-1"><i class="fa-regular fa-circle" style="color: #0563C1"></i></div><div class="col-5"><i class="fa-regular fa-circle" style="color: #0563C1"></i><span class="language-name-'+response.language.id+'">'+response.language.name+'</span></div><div class="col-6"><span class="language-level-'+response.language.id+'"> - '+response.language.level+'</span></div></div>');
