...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">SEO Page</h1>
    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="row card-header py-3 m-0">
            <h6 class="col font-weight-bold text-primary">SEO Page Edit</h6>
            <div class="col">
        ...
        <div class="card-body">
            <form action="{{ route('seo.update', $seo_page->id) }}" method="post" enctype="multipart/form-data">
                @csrf 
                @method('PUT')
                <div class="row">
                    <div class="col-4 form-group">
                        ...
                        <select name="page" id="page" class="form-control select_2 @error('page') is-invalid @enderror">
                            ...
                            <option value="{{ $page }}" @if( $seo_page->page_name == $page ) selected @endif>{{ $page }}</option>
                            @endforeach
                        </select>
                        @error('page')
                ...
                <div class="row">
                    <div class="col-4 image-upload form-group">
                        ...
                        <div class="image-edit position-relative">
                            <span>SEO Page Image 
                                <div class="image-preview">
                                    <label for="feature-image">
                                        @if(isset($seo_page->feature_image))
                                        <img src="{{ getS3File('seo/feature_image',$seo_page->feature_image) }}" alt="" id="imagePreview" class="w-100">
                                        @else
                                        <img src="https://via.placeholder.com/400x125" alt="" id="imagePreview" class="w-100">
                                        @endif
                                    </label>
                                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger feature-image-remove @if(!isset($seo_page->feature_image)) d-none @endif">
                            ...
                            <input type="hidden" name="file_name" value="{{ $seo_page->feature_image }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-4 form-group">
                        ...
                        <input type="text" name="seo_keyword" id="seo_keyword" class="form-control" value="{{ $seo_page->seo_keyword }}">
                    </div>
                ...
                <div class="row">
                    <div class="col-4 form-group">
                        ...
                        <textarea name="seo_description" id="seo_description" cols="30" rows="10" class="form-control">{!! $seo_page->seo_description !!}</textarea>
                    </div>
                </div>
