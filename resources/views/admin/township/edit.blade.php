        ...
        <div class="card-body">
            <form action="{{ route('city.update',$tonwship->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="radio" name="is_active" id="active" class="" value="1" @if($township->is_active == 1) checked required @endif> <label for="active"> Active</label><br>
                    <input type="radio" name="is_active" id="in_active" class="" value="0" @if($township->is_active == 0) checked required @endif> <label for="in_active"> In Active</label>
                </div>
