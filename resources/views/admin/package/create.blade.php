            ...
            <form action="{{ route('package-type.store') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    @foreach($package_items as $package_item)
                        <div class="col-4">
                            <input type="checkbox" name="package_item_id[]" id="package_item_id_{{ $package_item->id }}" value="{{ $package_item->id }}" class=""> <label for="package_item_id_{{ $package_item->id }}"> {{ $package_item->name }} ( {{ $package_item->point }} - point )</label><br>
                        </div>
                    @endforeach
                    </div>
                </div>
                ...
                <div class="form-group">
                    <input type="checkbox" name="is_clear_point" id="is_clear_point">
