...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="row card-header py-3 m-0">
            <h6 class="col font-weight-bold text-primary">State or Region Create</h6>
            <div class="col">
        ...
        <div class="card-body">
            <form action="{{ route('state.store') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" id="state" placeholder="Enter state or region name" required value="{{ old('name') }}">
                </div>
