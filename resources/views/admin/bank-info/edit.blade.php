...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="row card-header py-3 m-0">
            <h6 class="col font-weight-bold text-primary">Bank Information Edit</h6>
            <div class="col">
        ...
        <div class="card-body">
            <form action="{{ route('bank-info.update', $bank->id) }}" method="post" enctype="multipart/form-data">
                @csrf 
                @method('PUT')
                @if ($errors->any())
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="bank_name" id="bank_name" placeholder="Enter Bank Name" required value="{{ $bank->bank_name }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="radio" name="is_active" id="active" class="" value="1" @if($bank->is_active == 1) checked required @endif> <label for="active"> Active</label><br>
                    <input type="radio" name="is_active" id="in_active" class="" value="0" @if($bank->is_active == 0) checked required @endif> <label for="in_active"> In Active</label>
                </div>
