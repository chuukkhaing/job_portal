        ...
        <div class="card-body">
            <form action="{{ route('industry.update', $industry->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="radio" name="is_active" id="active" class="from-control" value="1" @if($industry->is_active == 1) checked required @endif> <label for="active"> Active</label><br>
                                <input type="radio" name="is_active" id="in_active" class="from-control" value="0" @if($industry->is_active == 0) checked required @endif> <label for="in_active"> In Active</label>
                </div>
