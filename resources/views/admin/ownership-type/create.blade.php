...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="row card-header py-3 m-0">
            <h6 class="col font-weight-bold text-primary">Ownership Type Create</h6>
            <div class="col">
        ...
        <div class="card-body">
            <form action="{{ route('ownership-type.store') }}" method="post">
                @csrf 
                <div class="form-group">
                    <label for="name">Ownership Type Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="name" id="name" placeholder="Enter Ownership Type name" required value="{{ old('name') }}">
                </div>
