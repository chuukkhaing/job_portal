...
@include('sweetalert::alert')
    ...
    <div class="row">
        ...
        <a href="{{ route('employers.index') }}" class="text-decoration-none col-xl-3 col-md-6 mb-4">
        ...
        <!-- Active Seeker -->
        <a href="{{ route('seeker.index') }}" class="text-decoration-none col-xl-3 col-md-6 mb-4">
        ...
        <!-- Online Job Post -->
        <a href="{{ route('job-posts.index') }}" class="text-decoration-none col-xl-3 col-md-6 mb-4">
        ...
        <a href="{{ route('job-posts.filter', ['status' => 'Pending']) }}" class="text-decoration-none col-xl-3 col-md-6 mb-4">
