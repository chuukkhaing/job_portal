...
<div class="container m-auto">
    ...
    <div class="tab-content" id="employerTabContent">
        ...
        <div class="tab-pane fade p-0" id="employer-job" role="tabpanel" aria-labelledby="employer-job-tab">Employer Jobs</div>
        <div class="tab-pane fade p-0" id="applicant-tracking" role="tabpanel" aria-labelledby="applicant-tracking-tab">Applicant Tracking</div>
