            ...
            <div class="row">
                ...
                <div class="col-9" style="background: white">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mb-4 seeker_attachment">
        ...
        $.ajax({
            ...
            if(response.status == 'success') {
                ...
                if(response.jobApply.length > 0) {
                    ...
                    $(".download_ic_cv").attr('href', document.location.origin+'/employer/download-ic-cv/'+response.seeker.id);
                    $("#seeker-org-attach").attr('src','')
                    $("#seeker-org-attach").attr('src', document.location.origin+'/storage/seeker/cv/'+response.seeker_attach.name+'#toolbar=0&navpanes=0&scrollbar=0');
