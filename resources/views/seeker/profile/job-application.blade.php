                                                ...
                                                <div class="card-header bg-transparent">
                                                    <div class="row">
                                                        <div class="col-12 col-lg-6 col-xl-5 mb-2 d-flex">
                                                            ...
                                                            <img src="{{ getS3File('employer_logo',$jobApplyBySeeker->JobPost->Employer->logo) }}" class="rounded-circle shadow align-self-center me-3" style="width: 50px; height: 50px" alt="{{ $jobApplyBySeeker->JobPost->Employer->name }}">
                                                            @else
                                                        ...
                                                        <div class="col-12 col-lg-12 col-xl-2 mb-2 text-end">
                                                            ...
                                                            @endauth
                                                            @auth('seeker')
                                                                <a href="{{ route('jobpost-apply', $jobApplyBySeeker->JobPost->id) }}" class="{{ $disabled }} btn-sm btn apply-company-btn py-2 px-3" onclick="applyJob({{ $jobApplyBySeeker->JobPost->id }})">
                                                    ...
                                                    <div class="tab-content" id="nav-tabContent">
                                                        <div class="tab-pane p-3 fade show active" id="nav-job-description-{{$jobApplyBySeeker->JobPost->id}}" role="tabpanel" aria-labelledby="nav-job-description-{{$jobApplyBySeeker->JobPost->id}}-tab">
                                                            ...
                                                            <div class="badge-group mb-3">
                                                                ...
                                                                <span class="my-1 badge text-white fz14 rounede-3 py-2 px-3 text-wrap" style="background: #0355d0">{{ $jobApplyBySeeker->JobPostSkill->Skill->name }}</span>
                                                                @endforeach
                                                            </div>
                                                            @endif
                                                                ...
                                                                <div class="card job-post-detail-company-profile mb-2">
                                                                    <div class="header">
                                                                        <div class="row">
                                                                            <div class="col-2 ">
                                                                                @if($jobApplyBySeeker->JobPost->Employer->logo && $jobApplyBySeeker->JobPost->hide_company == 0)
                                                                                <img src="{{ getS3File('employer_logo',$jobApplyBySeeker->JobPost->Employer->logo) }}" class="rounded-circle shadow align-self-center me-3 w-100" style="" alt="{{ $jobApplyBySeeker->JobPost->Employer->name }}">
                                                                                @else
                                                                        ...
                                                                        <div class="row px-2 pt-4">
                                                                            ...
                                                                            <div class="col py-4" >
                                                                                <div class="col-6 mx-auto text-center">
                                                                                    @if($jobApplyBySeeker->JobPost->Employer->logo && $jobApplyBySeeker->JobPost->hide_company == 0)
                                                                                    <img src="{{ getS3File('employer_logo',$jobApplyBySeeker->JobPost->Employer->logo) }}" class="rounded-circle shadow align-self-center me-3 w-50" style="" alt="{{ $jobApplyBySeeker->JobPost->Employer->name }}">
                                                                                    @else
