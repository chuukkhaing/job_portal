    ...
    <body>
        <div style="width: 100%;">
            <table width="100%" border="0" cellspacing="0" cellpadding="20" background="{{ asset('img/background/EMAIL_ACTIVATE_Recovered.jpg') }}" style="text-align: center; background-position: center; background-repeat: no-repeat; background-size: contain;">
                ...
                <tr>
                    <td>
                        <a href="{{ route('seeker-mobile-verify',$seeker->email_verification_token) }}" style="text-decoration: none; padding: 10px 50px; background: #0355D0; color: #FFD200; border-radius: 50px; box-shadow: 5px 5px 10px 0px rgba(0,0,0,0.2); font-weight: bold;">Activate</a>
                    </td>
                </tr>
                <tr>
                    <td>
