            ...
            $.ajax({
                ...
                success: function(response){
                            if(response.status == 'success') {
                                ...
                                $(".reference_label").append('<div class="row py-2 reference-resume-'+response.reference.id+'"><div class="row"><div class="col-1"><i class="py-2 fa-regular fa-circle" style="color: #0563C1"></i></div><div class="col"><span class="reference-name-'+response.reference.id+' exp-job-title">'+response.reference.name+'</span> | <span class="reference-position-'+response.reference.id+'">'+response.reference.position+'</span><br><span class="reference-company-'+response.reference.id+'  exp-company">'+response.reference.company+'</span><br><span class="reference-contact-'+response.reference.id+'">'+response.reference.contact+'</span></div></div></div>');
